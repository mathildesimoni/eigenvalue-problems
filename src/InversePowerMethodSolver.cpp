...
template <typename T>
void InversePowerMethodSolver<T>::SetMatrix(const Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic> A){ matrix=A; }

template <typename T>
void InversePowerMethodSolver<T>::FindEigenvalues(std::ostream &stream){
